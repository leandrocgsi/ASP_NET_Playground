...
namespace RestfulAPIWithAspNet.Helper
{
    public static class CultureHelper
    {
        ...
        private static readonly List<string> _cultures = new List<string> {
            "pt-BR", "pt", // first culture is the DEFAULT
            "es-ES", "es",
            "en-US", "en"
        ...
        public static string GetImplementedCulture(string name)
        {
            ...
            if (string.IsNullOrEmpty(name)) return GetDefaultCulture(); // return Default culture
            ...
            foreach (var c in _cultures) if (c.StartsWith(n)) return c;
